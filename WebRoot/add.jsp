...
<body>
	...
	<font color="red">${hasCustomer }</font>
		<input type="hidden" name="method" value="add">
		<table border="0" align="center" width="40%,20%"
			...
			<tr>
				...
				<td><input type="radio" name="gender" value="男" id="male"
					value="${customer.gender }" /> <label for="male">男</label> 
					<input type="radio" name="gender" value="女" id="female"
					value=${customer.gender } /> <label for="female">女</label></td>
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="button" value="添加客户" onclick="add()"/> 
